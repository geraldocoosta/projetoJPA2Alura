...
public class Produto {
	...
	/*
	 * Uma estrat�gia mais radical de Lock � impedir, de fato, que os conflitos
	 ...
	 * 
	 * A forma feita aqui � chamada de lock otimista, que lan�a uma exce��o com base
	 * na vers�o do objeto, anotado com @Version
	 */
	@Version
	private int versao;
