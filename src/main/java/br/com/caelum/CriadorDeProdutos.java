		...
		template.execute(new TransactionCallbackWithoutResult() {
			...
			protected void doInTransactionWithoutResult(TransactionStatus status) {
				...
				cursoDeViolao.setLinkDaFoto(
						"https://images.livrariasaraiva.com.br/imagemnet/imagem.aspx/?pro_id=4077676&qld=90&l=430&a=-1");
				...
				violao.setLinkDaFoto("https://images.livrariasaraiva.com.br/imagemnet/imagem.aspx/?pro_id=4077676&qld=90&l=430&a=-1");
